...
az deployment group create --resource-group "rg-mktg-crmio-dev-01" --template-file "mktg-showcase-generate-pdf-main.bicep" --parameters "mktg-showcase-generate-pdf-main-dev.bicepparam"
...
az deployment group create --resource-group "rg-mktg-crmio-dev-01" --template-file '.\templates\storage-accounts-role-assignments.bicep'  --parameters storageAccountName='stcrmiodevwe01' principalId="$currentUserId" principalType='User' roleDefinitionId='ba92f5b4-2d11-453d-a403-e96b0029c9fe' fileshareRoleDefinitionId='69566ab7-960f-475b-8e7c-b3118f30c6bd'

# delete resource group and all resources in it
az group delete --name "rg-mktg-crmio-dev-01"  
